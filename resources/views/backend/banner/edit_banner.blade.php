        ...
        <div class="card-body">
            ...
            <form method="post" action="{{ route('update.banner') }}" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="banner_title" class="form-control" type="text" value="{{$banner->banner_title}}" id="example-text-input">
                </div>
            </div>
           ...
           <input name="banner_image" class="form-control" type="file" id="image">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
  <img id="showImage" class="rounded avatar-lg" src="{{ asset($banner->banner_image) }}" alt="Card image cap">
                </div>
            </div>

            
<input type="submit" class="btn btn-info waves-effect waves-light" value="Update Banner">
            </form>
